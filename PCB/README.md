...
**BOM state.** The masters are now **`../BOM/solar-glow-drh-v4_0-BOM.xlsx`** and
**`../BOM/solar-glow-drh-v4_0-BOM-assembly.xlsx`** (moved from this folder 2026-08-01, beside the
live availability checker — `../BOM/README.md` shows current stock/lifecycle/price per line,
regenerated by `python3 BOM/check_stock.py`), reworked for the v4.0 managed-solar redesign - the passive diode/shunt/comparator parts (U2, U4, Q1, D1, D9–D11, R7–R9) are removed and the AEM10300 harvest chain (U7, U8, U9, L2, FB1, C22–C28, R15–R17) is added, on top of the earlier fixes:
