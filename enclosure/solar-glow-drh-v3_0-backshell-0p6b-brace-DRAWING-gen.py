...
leader(X(13.0),Y(35.0),96,142,"2\u00d7 LOCATOR PILLAR  \u00d83.0 \u00d7 0.6 TALL (NOTE 4)",ha="left",fs=5.6)
...
notes=[
 ...
 "4. 2x LOCATOR PILLAR: Ø3.0 x 0.6 TALL, STANDING ON THE CAVITY FLOOR AT (13, 35) AND (33, 55) - BOTH WEST OF THE NFC COIL. LEFT AS ISLANDS IN THE SAME CAVITY PASS AS THE BOSSES.",
