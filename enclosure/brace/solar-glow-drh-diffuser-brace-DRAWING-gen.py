...
notes=[
 ...
 "4. LOCATOR RECESSES: 2\u00d7 \u00d83.2 \u00d7 0.8 DEEP IN THE FLAT BOTTOM AT (13, 35) AND (33, 55). THEY RECEIVE THE SHELL'S 2\u00d7 \u00d83.0 \u00d7 0.6 METAL PILLARS",
 "    (0.6 ENGAGEMENT, 0.1 RADIAL + 0.2 AXIAL CLEARANCE). BOTH WEST OF THE NFC COIL. THIS IS THE ONLY LOCATION TIE TO THE SHELL.",
