...
- [ ] **[FW+BOM DONE -> SCH+PCB] EN_STO_CH cold-start deadlock fix: NFET buffer CHOSEN (Q2 BSS138LT1G
  ...
  and R18 on the shared 1M line. SCH: Q2 + R18 symbols injected 2026-07-23 (parked in free space at (934.7, 372.1)/(934.7, 391.2), right of the EN_STO_CH area -- drag into place while wiring). Hookup: gate <- PA4 (rename that segment e.g. `CHG_DIS_G`),
